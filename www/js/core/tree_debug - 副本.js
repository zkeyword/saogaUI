								...
								if( data ){
									...
									for(var i = 0; i<data.length; i++){
										if( Number(data[i].pId) === pId ){
											...
											if( isCheckBox ){
												checkHtml = '<span class="l-tree-check l-tree-checkbox" data-level="'+ level +'"></span>';
											}
								...
								var that    = $(e.currentTarget),
									...
									checkFn = function(obj){
													...
													if( !isChecked ){
														...
														if( parents.find('.l-tree-check[data-level="'+ level +'"].l-tree-checkbox-checked-part').length ){
															parentCheck.addClass('l-tree-checkbox-checked-part');
														}
